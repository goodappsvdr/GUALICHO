<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmPagoExitoso.aspx.vb" Inherits="GUALICHO.FrmPagoExitoso" %>
                ...
                <div class="container" style="margin-right: auto; margin-left: auto;padding-left:30px; padding-right: 50px; width:100%;" >
                    ...
                    <div class="row" >
                        ...
                        <div class="menumenu__container clearfix">
                            ...
                            <div class="col-md-8 col-lg-8 col-sm-4 col-xs-3">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner" style="background-color:black" >
                                  ...
                                  <span class="breadcrumb-item active" style="color:white;">Pago Exitoso</span>
...
<img src="Imagenes/confirmado.png" style="height:120px;" />
                            <br />  <br />
                             <br />
                            <h2>¡EL PAGO SE REALIZO CON ÉXITO!</h2>
                            <br />  <br />
