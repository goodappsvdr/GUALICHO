Tranuilo<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmPagoPendiente.aspx.vb" Inherits="GUALICHO.frmPagoPendiente" %>
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner" style="background-color:black" >
                                  ...
                                  <span class="breadcrumb-item active" style="color:white;">Pago Pendiente</span>
...
<img src="Imagenes/pendiente.png" style="height:120px;" />
                            <br />  <br />
                             <br />
                            <h2>ATENCIÓN, EL PAGO ESTA PENDIENTE <br /> <br /><h3>Tranquilo/a, ¡Puedes ver el estado de tu pago en Mis Compras!</h3></h2>
                            <br />  <br />

                               <button type="button" style="margin-right:20px; background:#035EB9; font-family: 'Poppins', sans-serif; color:White; border:none; height:45px; width:100%; max-width:400px;    font-size:14px;"  onclick="Volver()">VER MIS COMPRAS</button>
                                   </center>
    ...
    <script>
        ...
        function Volver() {
          window.location.href = "http://cerveceriagualicho.com/FrmMisCompras.aspx";
        }
