<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmPagoRechazado.aspx.vb" Inherits="GUALICHO.frmPagoRechazado" %>
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner" style="background-color:black" >
                                  ...
                                  <span class="breadcrumb-item active" style="color:white;">Pago Rechazado</span>
...
<img src="Imagenes/rechazado.png" style="height:120px;" />
                            <br />  <br />
                             <br />
                            <h2>UPS, EL PAGO HA SIDO RECHAZADO <br /> <br /><h3>Tranquilo/a, ¡Intenta pagar nuevamente en mis compras!</h3></h2>
                            <br />  <br />
