...
<body>
  ...
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="70px" viewBox="0 0 100 68">
    <g id="large">
      <g>
		...
		c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="#D87C2D" />
      ...
      <g id="small">
		...
		C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#D87C2D" />
  ...
  <p>
  Por favor, perdona las molestias.<br />
Actualmente estamos inicializando nuestro nuevo sitio.
  </p>
  <p>
   Está bien, ¡también estamos emocionados!
  </p>
			<br /><br />
            <img src="Imagenes/logo.png" style="height:80px; opacity:0.5" />
