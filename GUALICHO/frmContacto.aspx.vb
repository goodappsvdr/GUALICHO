...
#Region "Contacto"
    ...
    Public Sub Contacto()
        ...
        Dim Direccion As String = ods.Tables(0).Rows(0).Item("Direccion").ToString
        Dim Email As String = ods.Tables(0).Rows(0).Item("Email").ToString
        Dim Telefono As String = ods.Tables(0).Rows(0).Item("Telefono").ToString
        Dim Mapa As String = ods.Tables(0).Rows(0).Item("Mapa").ToString
...
#End Region
    ...
    Public Shared Function Consulta_Enviar_Ws(ByVal cadena As String) As String
        ...
        Try
            ...
            Dim Email As String = Convert.ToString(dict(0).Email)
            Dim Asunto As String = Convert.ToString(dict(0).Asunto)
            ...
            Dim oObjeto2 As New Consultas

            resultado = oObjeto2.Agregar(RazonSocial, Email, Asunto, Mensaje)
