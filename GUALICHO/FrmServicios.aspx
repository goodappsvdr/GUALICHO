<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmServicios.aspx.vb" Inherits="GUALICHO.FrmServicios" %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="search__inner" style="padding-right: 60px;">
                                    ...
                                    <input placeholder="Qué estas buscando?" id="TxtBusquedaGenerica"  type="text" style="background: #fff none repeat scroll 0 0;border: medium none;
    color: #333;
    font-size: 25px;
    font-weight: 300;
    height: 60px;
    ...
    font-family: 'Poppins', sans-serif; ">
        ...
        <!-- Start Product Grid -->
            ...
            <div class="container">
                ...
                <asp:Repeater runat="server" ID="RepeaterServicios"><ItemTemplate>
                    <div class="col-sm-12 col-md-8" style="padding:10px;">
                         <a href='<%# Eval("UrlWebClientes")%>'>
                        <div style="background:#000; color:white; padding:20px; "><center><h2 style="color:white;"><%# Eval("nombre")%></h2></center></div>
                       </a>
                    </div>
                       <div class="col-sm-12 col-md-4" style="padding:10px;">
                             <a href='<%# Eval("UrlWebClientes")%>'>
                             <div class="VerMas"><center>
                   <h2 style="color:white;">Ver más información</h2>
                                 </center>
                                 </div></a>
                     </div>
