...
<body>
    ...
    <![endif]-->
        <div class="DivLoader" id="DivLoader1" style="display:none;">
            ...
            <img style="margin: 0; position: absolute; top: 20%; left: 50%; -ms-transform: translate(-50%, -50%);
                ...
                src="https://www.pointcomfort.com/ResourcePackages/PointComfort/assets/dist/images/spinner.gif" />
    ...
    text-align: left;">
            ...
            <div class="ht__bradcaump__area"
                style="background: rgba(0, 0, 0, 0) url(imagenes/imgRubros.jpg) no-repeat scroll center center / cover ;">
                            ...
                            <div class="col-xs-12">
                                <div class="bradcaump__inner">
                                    <nav class="bradcaump-inner" style="background-color:black">
                                        <a class="breadcrumb-item" href="frmInicio.aspx"
                                            style="color:white;">Principal</a>
                                        <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    ...
                                    <br />
                                    <span id="TxtDescripcion1" runat="server"
                                        style="color:black;font-family: 'Poppins', sans-serif; ">
                                        En nuestra empresa encontrara una gran linea de productos de excelente calidad,
                                        desde queso duro, semiduro y blando. Contamos con más de diez tipos de quesos.

                                        Nuestro objetivo es seguir creciendo dia a dia y para crecer, solo es posible si
                                        el cliente elige los productos Linea Dorada S.A, es por eso que intentamos
                                        mejorar la calidad de nuestros exquisitos quesos. Hace 25 años que se creó esta
                                        empresa, con el objetivo del valor agregado a la produccion de leche de nuestros
                                        tambos.

                                        Con el tiempo para satisfacer la demanda se empezó a comprar leche a otros
                                        tambos, siempre cuidando que cumplan los requisitos de calidad de leche que
                                        hemos establecido en menos de 20.000 ufc y menos de 280.000 celulas somaticas.

                                        Con una filosofía tradicional y seria, el objetivo principal de Linea Dorada S.A
                                        es ofrecer un producto de máxima calidad, elaborado con las mejores materias
                                        primas y, como no, con el mejor servicio y trato a sus clientes.

                                        Actualmente disponemos de las más avanzadas tecnologías, mejorando día a día e
                                        innovando en sus sistemas de Control, tanto de Calidad, como de Elaboración.
                                        Nuestra empresa sigue inmersa en el saber hacer, para poder ofrecérselo a sus
                                        amigos y clientes, mejorando continuamente y avanzando con los tiempos.

                                        El Saber Hacer, nuestras Recetas y nuestros estrictos Controles de Calidad, han
                                        dado como resultado los más exquisitos Quesos, ampliamente reconocidos de manera
                                        nacional, y ganadores de numerosos premios a lo largo de los años.
                                    </span>

                                </div>
                                <div class="col-sm-12 col-md-4">

                                    <img id="ImgEmpresa" runat="server"
                                        src="http://www.lineadorada.com.ar/Imagenes/Empresa/1.jpg" />
                                </div>
                            ...
                            <div class="row">
                                <center>
                                    ...
                                    <span id="TxtDescripcion2" runat="server"
                                        style="color:black;font-family: 'Poppins', sans-serif; ">
                                        Elaboramos quesos que hacen los momentos más especiales de todas las ocasiones.

                                        Quesos que dan gran sabor y gusto incluso a los usos más cotidianos, para
                                        hacerte sentir en cada instante la riqueza de lo auténtico.

                                        Elaborados con dedicación artesana, pero también con la garantía y posibilidades
                                        que el saber de hoy nos ofrece para vivir mejor. Sólo así, todos y en todo
                                        momento podremos disfrutar de lo mejor. Linea Dorada S.A no es solo una empresa,
                                        todos su miembros son una gran familia que cada día cada uno de sus miembros
                                        aporta su experiencia y dedicación para elaborar productos cuidados desde la
                                        recogida de la leche, siempre fresca del día, hasta que sale el producto de
                                        nuestras instalaciones siempre puesto a punto para ser degustado por los
                                        consumidores.

                                        El compromiso firme con la satisfacción de nuestros clientes hace de Linea
                                        Dorada una empresa orientada a conseguir el máximo nivel calidad. Un compromiso
                                        que se materializa en nuestras certificaciones de calidad que se aplican en cada
                                        fase del proceso de producción para garantizar la excelencia en cada uno de
                                        nuestros productos.
    ...
    <li data-target="#myCarousel" data-slide-to="2"></li>
                                    ...
                                    <div class="carousel-inner">
                                        <asp:Repeater runat="server" ID="RepeaterImagenesNosotros">
                                            <ItemTemplate>
                                ...
                                <div class="footer">
                                    ...
                                    <div class="ft__details">
                                        <p style="font-family: 'Poppins', sans-serif;">Recordás cuando ibas a tu bar
                                            favorito y pedías esa pinta de birra que tanto te gustaba? Recordás el
                                            primer aroma que sentías cuando la llevabas a la boca? Y cuando la pasabas
                                            por la garganta? Esa sensación de mezcla entre gusto y regusto? Todo eso lo
                                            pensamos cada vez que armamos una receta. Disfruta cada trago. Hasta la
                                            birra!</p>
                                        <div class="ft__social__link">
                                            <ul class="social__link">
                                                ...
                                                <li><a href="#" id="HrefFacebook" runat="server"><i><img
                                                                ...
                                                                src="imagenes/icono facebook gualicho.png" /></i></a>
                                                </li>

                                                <li><a href="#" id="HrefInstagram" runat="server"><i><img
                                                                style="width:33px; height:30px"
                                                                src="imagenes/icono instagram gualicho.png" /></i></a>
                                                </li>

                                                <li><a href="#" id="HrefWhatsapp" runat="server"><i><img
                                                                style="width:33px; height:30px"
                                                                src="imagenes/icono whatsapp gualicho.png" /></i></a>
                                                </li>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="copyright__inner">
                                    <p style="font-family: 'Poppins', sans-serif;">Copyright© <a style="color:white"
                                            href="https://www.goodapps.com.ar/">GoodApps</a> 2019-2020. Todos los
