<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmFinalizarCompra.aspx.vb" Inherits="GUALICHO.FrmFinalizarCompra" %>
<!doctype html>
...
<body>
   ...
   <div class="wrapper">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner" style="background-color:black" >
                                  ...
                                  <span class="breadcrumb-item active" style="color:white;">Finalizar Compra</span>
    ...
    <tbody id="GrillaFinalizarCompra">
                ...
                <span style="float:right; margin-right:20px; color:black; font-size:22px; font-family: 'Poppins', sans-serif;" id="TxtTotalGeneralFinalizarCompra"></span>
             ...
             <br />
                ...
                <hr />
                            ...
                            <input id="TxtDomicilio" placeholder="Escriba su domocilio, por favor..." style=" margin-top:10px; border:none; border-bottom:1px solid #000; color:#000; width:100%; font-size:14px;font-family: 'Poppins', sans-serif;" />
                          
                            <input id="TxtGeolatitud" style="display:none;" />
                            ...
                            <input id="TxtGeoLongitud"  style="display:none;" />
                                 ...
                                 <div class="col-md-6">
                                     ...
                                     <span style="font-family: 'Poppins', sans-serif; font-size:16px; color:black;">Entre Calles:</span>
                            <br />

                            <input id="TxtEntreCalles" placeholder="Escriba entre que calles, por favor..." style="margin-top:10px; border:none; border-bottom:1px solid #000; color:#000; width:100%; font-size:14px;font-family: 'Poppins', sans-serif;" />
                            ...
                            <div id="PanelCarritoGif" style="display:none;">

                                <br />     <br />     <br />
                                <center>
                                <span style="width:100%;"><img src="https://i.stack.imgur.com/Ndsyl.gif" style=" height:100px;"></span>
                                     <br />     <br />     <br />
                                </center>
                                </div>
    ...
    <script>
        ...
        function FinalizarPagar() {
            ...
            $.ajax({
                type: "POST",
                "url": "frmFinalizarCompra.aspx/FinalizarYPagar_Ws",
        ...
        function CargarFinalizarCompra() {
        ...
        function ValidarEliminarItemCompra(id, item) {
            swal({
        ...
        function EliminarItemCompra(id_carrito) {
