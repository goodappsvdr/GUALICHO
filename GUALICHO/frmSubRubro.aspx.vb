...
#End Region
    ...
    Private Sub CargarMarcas()
        ...
        Dim ids() As String
        Dim id_rubro As String
        Dim Id_subrubro As String

        id_rubro = Request.QueryString("ID")
        ...
        oDs = oObjeto.Marcas_BuscarPorID_SubRubro(Id_subrubro)
        RepeaterMarcas.DataSource = oDs.Tables(0)
        RepeaterMarcas.DataBind()

    End Sub
    Public Sub CargarItemsRubros()
        ...
        ods = oObjeto.Items_BuscarPorID_RubroYID_SubRubro_N(id_rubro, Id_subrubro)
        ...
        ods1 = oSubRubro.SubRubros_BuscarPorID(Id_subrubro)

        txtSubRubro.InnerHtml = ods1.Tables(0).Rows(0).Item("Descripcion").ToString
