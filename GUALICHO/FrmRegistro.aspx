<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmRegistro.aspx.vb" Inherits="GUALICHO.FrmRegistro" %>
    ...
    font-family: 'Poppins', sans-serif;" onkeydown="EnterBusqueda()">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner" style="background-color:black" >
                                  ...
                                  <span class="breadcrumb-item active" style="color:white;">Crear Cuenta</span>
                                </nav>
                            </div>
                        </div>
                    </div>
        ...
        <input id="TxtConfirmarPass" type="Password"  placeholder="Confirmar Contraseña" style="border:none; border-bottom:1px solid #000; color:#000; width:100%; font-size:14px;font-family: 'Poppins', sans-serif;" />
                 <br />  <br />
                        ...
                        <button onclick="CrearUsuario()" id="cmdEnviarConsulta" type="button" style=" background:#000; font-family: 'Poppins', sans-serif; color:White; border:none; height:45px; width:100%;    font-size:14px;  ">Registrarme</button>
               <br />      <br />
  ...
  <footer id="htc__footer" style="background-color:#000">
    ...
    <script>
        ...
        function CrearUsuario() {
            ...
            var ConfirmarPass = $('#TxtConfirmarPass').val();
            var DNI = $('#TxtDNI').val();
            ...
            if (Pass == ConfirmarPass) {
                ...
                var par = "{\"RazonSocial\":\"" + RazonSocial + "\"" + ",\"Email\":\"" + Email + "\"" + ",\"Pass\":\"" + Pass + "\"" + ",\"DNI\":\"" + DNI + "\"}";
                ...
                $.ajax({
                    type: "POST",
                    url: "FrmRegistro.aspx/Usuarios_Crear_Web",
        ...
        function EnviarEmailContacto() {
            ...
            $.ajax({
                type: "POST",
                url: "FrmRegistro.aspx/EnviarEmailContacto_Ws",
                data: JSON.stringify(payload),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
