<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmLogin.aspx.vb" Inherits="HIERCONS.frmLogin" %>
            ...
            <div class="container">
                ...
                <input id="TxtPass" type="Password" placeholder="Contraseña" style="border:none; border-bottom:1px solid #ef7f2d; color:#ef7f2d; width:100%; font-size:14px;font-family: 'Poppins', sans-serif;" />
                 <br />  <br />
                        ...
                        <button onclick="IrALogin()" id="cmdEnviarConsulta" type="button" style=" background:#ef7f2d; font-family: 'Poppins', sans-serif; color:White; border:none; height:45px; width:100%;    font-size:14px;  ">Iniciar Sesión</button>
               <br />      <br />
                                   <div style="padding:10px; border-radius:10px; border:1px solid #ef7f2d;">

                              <a style="text-decoration:none; cursor:pointer;" href="FrmRegistro.aspx"><span style="color:#ef7f2d; font-family: 'Poppins', sans-serif; ">¿No tienes cuenta? Click aquí!</span></a>
