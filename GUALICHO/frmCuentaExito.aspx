<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCuentaExito.aspx.vb" Inherits="GUALICHO.frmCuentaExito" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <center>
                            <img src="Imagenes/checked.png" style="height:80px;" />
                                        <br />     <br />
                               <div style="width:100%; max-width:500px;">
<h1>CUENTA ACTIVADA CON ÉXITO</h1>
                                  <br />
                                   <a style=" background:#ef7f2d; font-family: 'Poppins', sans-serif; color:White; border:none; height:45px; width:100%; padding:15px;    font-size:14px;  " href="frmLogin.aspx">INICIAR SESIÓN</a>
                                   </div>
                                   </center>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.10.1/sweetalert2.min.js"></script>
        ...
        <script>
            function EnviarEmailContacto() {
                ...
                $.ajax({
                    type: "POST",
                    url: "frmCuentaExito.aspx/EnviarEmailContacto_Ws",
