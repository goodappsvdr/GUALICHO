           ...
           <div id="sidebar-menu">
                    <ul>
                        ...
                        <li id="Men_Banners" visible="false" runat="server" class="has_sub"><a href="javascript:void(0);"
                            class="waves-effect"><i class="zmdi zmdi-view-list"></i><span>Portada</span><span
                                class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                        ...
                        <li id="Men_Item" visible="false" runat="server" class="has_sub"><a href="javascript:void(0);"
                            ...
                            <ul class="list-unstyled">
                                <li><a href="frmItemsABM.aspx">Nuevo Producto></li>
                                <li><a href="frmItems.aspx">Editar Productos</a></li>
                            </ul>
                        </li>
                        <li id="Men_ItemImagen" visible="false" runat="server" class="has_sub"><a href="javascript:void(0);"
                            class="waves-effect"><i class="zmdi zmdi-view-list"></i><span>Imágenes de Productos</span><span
                                class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                   ...
                                   <%--EMPIEZO BACKEND--%>
                                    ...
                                    <center>
                                        ...
                                        <div  class="form-group">
                                          ...
                                          <div runat="server" id="divPedidos">
                ...
                <ItemTemplate>
                                      ...
                                      <h3  runat="server" id="lblItem"> <%# Eval("productoConsulta")%></h3>


                                       <span style="color:#ff6600; font-size:18px; "><%# Eval("NumeroPedido")%></span>
                                       <br />
                                       ...
                                       <span style="color:#000; font-size:18px; ">Imágen</span>

                                       <br />

                                       
                                        <img src='<%# Eval("imagen")%>' id="ImagenPrincipal" runat="server"  style=" width:80%;  height:170px;border: 8px solid #fff;
    box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.2); object-fit:cover; " />
                                          ...
                                          <br />
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col col-md-6">
                                         <span style="color:#000; font-size:18px; "> Interesado</span>
                                             <asp:TextBox ID="txtUsuario"  runat="server"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                       </div>

                                         <div class="col col-md-6">
                                         <span style="color:#000; font-size:18px; "> Teléfono</span>
                                             <asp:TextBox ID="TxtTelefono"  runat="server"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                       </div>
                                              ...
                                              <br />
                                              <div class="row" style=" background:#d4d4d4; padding:20px; ">
                                             
                                              <div class="col col-md-12" >

                                               <span style="color:#000; font-size:18px; "> Consulta recibida</span>

                                              <div style=" float:left; background:whitE;padding:5px;   width: 100%;" >
                                                ...
                                                <asp:TextBox ID="TxtMensaje"  TextMode="MultiLine" runat="server"  ForeColor="Black"
                                                    Height="200px" style="    border: none;line-height: 1.5em;" Width="100%"></asp:TextBox>
                                              </div>
                                              ...
                                              <div class="row"  style=" background:#ff6600;   padding:20px;">
                                              
                                              <div class="col col-md-8">


                                                <asp:TextBox ID="txtEnviar" TextMode="MultiLine"  runat="server"  ForeColor="Black"
                                                   style=" background:white;"  Height="100px" Width="100%"></asp:TextBox>
                    ...
                    ACEPTAR Y ENVIAR RESPUESTA</button>
                                    ...
                                    <asp:HiddenField ID="HfID_Consulta" runat="server" />
                                    <br />
