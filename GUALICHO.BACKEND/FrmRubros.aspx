<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmRubros.aspx.vb" Inherits="HIERCONS.BACKEND.FrmRubros" %>
...
<div class="se-pre-con"></div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable" class="table table-striped table-bordered" style="cursor:pointer;">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="RepeaterRubros" runat="server">
                                            <ItemTemplate>
 ...
 <center>
                                <a href="./frmRubrosABM.aspx" style=" background:#ef7f2d !important; border: 1px solid #ef7f2d !important;" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5"> NUEVO RUBRO</a>
