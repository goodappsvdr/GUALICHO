<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmServiciosABM.aspx.vb" Inherits="GUALICHO.BACKEND.FrmServiciosABM" %>
            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="row"  runat="server" id="PanelControles">
                                    ...
                                    <center>
                                     ...
                                     <asp:Button  runat="server" id="cmdAceptar"   style=" width:100%; min-width:220px; color:White; background:#000 !important; border: 1px solid #000 !important; border-radius: 2em; padding: 6px 18px;" runat="server" Text="ACEPTAR"></asp:Button>
                                            ...
                                            <hr />
                                             ...
                                             <asp:Button  runat="server" id="btnNuevaImagenServicio"   style=" width:100%; min-width:220px; color:White; background:#2DC64F !important; border: 1px solid #2DC64F !important; border-radius: 2em; padding: 6px 18px;" runat="server" Text="IMAGENES DEL SERVICIO"></asp:Button>
                        ...
                        <asp:HiddenField ID="HfID_Servicio" runat="server" />
