<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmItemImagenes.aspx.vb" Inherits="GUALICHO.BACKEND.frmItemImagenes" %>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable" class="table table-striped table-bordered" style="cursor:pointer;">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="RepeaterItemImagenes" runat="server">
                                            <ItemTemplate>
                                                <tr onClick="window.open( '<%# Eval("urlweb1")%>','_top' ); return false;">
                                                    <th>
