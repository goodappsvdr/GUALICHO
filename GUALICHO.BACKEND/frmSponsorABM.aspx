<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmSponsorABM.aspx.vb" Inherits="HIERCONS.BACKEND.frmSponsorABM" %>
...
<body class="fixed-left">
   ...
   <asp:PostBackTrigger ControlID="BtnAceptar" />
                                   ...
                                   <%--EMPIEZO BACKEND--%>
                                    ...
                                    <center>
                                       ...
                                       <div class="col col-md-12">
                                         <span style="color:#ef7f2d; font-size:18px; "> Nombre del Sponsor</span>
      ...
      <center> <asp:FileUpload style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer;margin-top:-5px;decoration:none;"  runat="server" id="btnSubirImg"  onchange="readURL(this);" runat="server"></asp:FileUpload></center></div>
                                                  ...
                                                  <div class="col col-md-6">
                                        <br />
                                        <img src="" id="ImgSponsor" runat="server"  style=" width:300px;  height:100px;border: 8px solid #fff;
...
<%--<asp:Button ID="cmdAceptar" runat="server"  style=" width:100%; background:#ef7f2d !important; border: 1px solid #ef7f2d !important;"  class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5" Text="ACEPTAR"></asp:Button>--%>
  <asp:Button  runat="server" id="BtnAceptar"  style=" width:100%; min-width:220px; color:White; background:#ef7f2d !important; border: 1px solid #ef7f2d !important; border-radius: 2em; padding: 6px 18px;" class="btn btn-success" Text="ACEPTAR"></asp:Button>
                                ...
                                <asp:HiddenField ID="HfID_Sponsor" runat="server" />
                                <br />
