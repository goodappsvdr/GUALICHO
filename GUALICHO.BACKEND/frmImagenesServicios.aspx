<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmImagenesServicios.aspx.vb" Inherits="GUALICHO.BACKEND.frmImagenesServicios" %>
...
<div class="se-pre-con"></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <h4 runat="server" id="TxtServicio" class="header-title m-t-0 m-b-30">
                                    </h4>
                                ...
                                <table id="datatable" class="table table-striped table-bordered" style="cursor:pointer;">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="RepeaterImagenesNosotros" runat="server">
                                            <ItemTemplate>
                                                <tr onClick="window.open( '<%# Eval("urlweb")%>','_top' ); return false;">
                                                    <th>

                                                        <img src="<%# Eval("Imagen")%>"  style="object-fit:cover; height:150px; width:150px;"/>
                                                    </th>
 ...
 <center>
                               <%-- <a href="./frmNosotrosImagenesABM.aspx" style=" background:#ef7f2d !important; border: 1px solid #ef7f2d !important;" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5"> NUEVA IMÁGEN</a>
                           --%>
                         <br />
                                       

     <asp:Button ID="BtnNuevoImagenServicio"   style=" width:50%; background:#ef7f2d !important; border: 1px solid #ef7f2d !important; background:#ef7f2d; border-radius:50px; padding:10px; color:white;" runat="server" Text="  NUEVA IMAGEN" />
