      ...
      <center> <asp:FileUpload style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer;margin-top:-5px;decoration:none;"  runat="server" id="btnSubirImg"  onchange="readURL(this);" runat="server"></asp:FileUpload></center></div>
                                ...
                                <div class="row col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 19px;">
                                    ...
                                    <div class="input-field col s8" style="padding-top: 19px;">
                                        ...
                                        <telerik:RadEditor ID="TxtDescripcionPrinicipal" style="width:100%;" OnClientLoad="OnClientLoad"
                                ...
                                <div class="row col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 19px;">
                                    ...
                                    <div class="input-field col s8" style="padding-top: 19px;">
                                        ...
                                        <telerik:RadEditor ID="TxtDescripcionSecundaria" style="width:100%;" OnClientLoad="OnClientLoad"
                                            Skin="Metro" runat="server" EditModes="Design" Language="es-AR" BorderColor="White"
                                            BorderStyle="Solid" EnableResize="False">
                                            <Paragraphs>
                                                <telerik:EditorParagraph Tag="" Title="New EditorParagraph" />
