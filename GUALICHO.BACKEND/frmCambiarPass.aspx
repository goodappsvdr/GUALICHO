<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmCambiarPass.aspx.vb" Inherits="HIERCONS.BACKEND.frmCambiarPass" %>
                                   ...
                                   <%--EMPIEZO BACKEND--%>
                                    ...
                                    <center>
                                       ...
                                       <div class="col col-md-4">
                                         <span style="color:#ef7f2d; font-size:18px; ">Contraseña Actual</span>
                                             <asp:TextBox ID="TxtPassActual" required runat="server" TextMode="Password"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                       </div>
                                      
                                       <div class="col col-md-4">
                                           <span runat="server" id="TituloOrden" style="color:#ef7f2d; font-size:18px;  " >Nueva Contraseña </span>
                                             <asp:TextBox ID="TxtNuevoPass" required runat="server" TextMode="Password"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                      </div>
                                       ...
                                       <div class="col col-md-4">
                                           <span runat="server" id="Span1" style="color:#ef7f2d; font-size:18px;  " >Confirmar Nueva Contraseña </span>
                                             <asp:TextBox ID="TxtConfirmarNuevoPass" required runat="server" TextMode="Password"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                      </div>
