...
#Region "IMG NOSOTROS"
    Private Sub CargarImgNosotros()
        ...
        If oDs.Tables(0).Rows.Count > 0 Then
            ...
            lblTitulo.InnerText = "EDITAR IMÁGENES NOSOTROS"
        ...
        Else
            lblTitulo.InnerText = "NUEVO IMÁGENES NOSOTROS"
    ...
    Private Sub ModificarImgNosotros()
        ...
        tituloStatus = "IMÁGEN NOSOTROS MODIFICADA EXITOSAMENTE"
    ...
    Private Sub AgregarImgNosotros()
        ...
        If btnSubirImg.HasFile = True Then
            ...
            Dim tituloStatus As String
            tituloStatus = "IMÁGEN NOSOTROS AGREGADA EXITOSAMENTE"
