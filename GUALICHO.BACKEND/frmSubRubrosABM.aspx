<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmSubRubrosABM.aspx.vb" Inherits="GUALICHO.BACKEND.frmSubRubrosABM" %>
            ...
            <div class="content">
                ...
                <div class="container">
                                   ...
                                   <%--EMPIEZO BACKEND--%>
                                    ...
                                    <center>
                                       ...
                                       <div class="col col-md-6">
                                         <span style="color:#ef7f2d; font-size:18px; "> Nombre del Sub Rubro</span>
                                       ...
                                       <div class="col col-md-6">
                                        ...
                                        <asp:DropDownList class="form-control select2"  Height="50px" style=" width:100%;" ID="CboRubro" runat="server" AppendDataBoundItems="True"
                                 AutoPostBack="true">
                            </asp:DropDownList>
                                      </div>
                    ...
                    ACEPTAR</button>
                      ...
                      <asp:HiddenField ID="HfID_SubRubro" runat="server" />
