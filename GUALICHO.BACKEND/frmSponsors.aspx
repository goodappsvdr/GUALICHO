<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmSponsors.aspx.vb" Inherits="HIERCONS.BACKEND.frmSponsors" %>
...
<div class="se-pre-con"></div>
                                            ...
                                            <ItemTemplate>
                                                <tr onClick="window.open( '<%# Eval("urlweb")%>','_top' ); return false;">
                                                    <th>
                                                        ...
                                                        <th>
                                                       <img src="<%# Eval("IMAGEN")%>" style=" width:140px; height:50px;" />
                                                    </th>
 ...
 <center>
                                <a href="./frmSponsorABM.aspx" style=" background:#ef7f2d !important; border: 1px solid #ef7f2d !important;" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5"> NUEVO SPONSOR</a>
