<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmImagenesServiciosABM.aspx.vb" Inherits="HIERCONS.BACKEND.frmImagenesServiciosABM" %>
...
<body class="fixed-left">
   ...
   <asp:PostBackTrigger ControlID="BtnAceptar" />
      ...
      <center> <asp:FileUpload style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer;margin-top:-5px;decoration:none;"  runat="server" id="btnSubirImg"  onchange="readURL(this);" runat="server"></asp:FileUpload></center></div>
                                                  ...
                                                  <div class="col col-md-6">
                                        <br />
                                        <img src="" id="ImgServicio" runat="server"  style=" width:300px;  height:300px;border: 8px solid #fff;
...
<asp:Button  runat="server" id="BtnAceptar"  style=" width:100%; min-width:220px; color:White; background:#ef7f2d !important; border: 1px solid #ef7f2d !important; border-radius: 2em; padding: 6px 18px;" runat="server" Text="ACEPTAR"></asp:Button>
                                ...
                                <asp:HiddenField ID="HfID_ImagenesServicios" runat="server" />
                                <br />
