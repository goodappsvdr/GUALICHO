<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmItemImagenesABM.aspx.vb" Inherits="GUALICHO.BACKEND.frmItemImagenesABM" %>
   ...
   <asp:PostBackTrigger ControlID="cmdAceptar" />
                                    ...
                                    <center>
                                      ...
                                      <h3  runat="server" id="lblItem"></h3>
                                       ...
                                       <br />
                                        ...
                                        <img src="" id="ImagenPrincipal" runat="server"  style=" width:170px;  height:170px;border: 8px solid #fff;
    box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.2); object-fit:cover; border-radius:50px;" />
      ...
      <center> <asp:FileUpload style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer;decoration:none; "  runat="server" id="btnSubirImg1"  onchange="readURL1(this);" runat="server"></asp:FileUpload></center></div>

  
                                        <img src="" id="Imagen1" runat="server"  style=" width:250px;  height:250px; margin-top:15px; border: 8px solid #fff;
    box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.2); object-fit:cover;" />
       <br />  
                                    ...
                                    <div alt="Cargando Imagen..." style="background-image:url('Imagenes/subir.png');background-size: cover;height:50px;width:50px;cursor:pointer;decoration:none;" required="" name="imagen" id="Div1" type="file" accept="image/*">
      <center> <asp:FileUpload style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer;decoration:none;"  runat="server" id="btnSubirImg2"  onchange="readURL2(this);" runat="server"></asp:FileUpload></center></div>

     
                                        <img src="" id="Imagen2" runat="server"  style=" width:250px;  height:250px; margin-top:15px; border: 8px solid #fff;
    box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.2); object-fit:cover;" />
        <br />  
                                    ...
                                    <div alt="Cargando Imagen..." style="background-image:url('Imagenes/subir.png');background-size: cover;height:50px;width:50px;cursor:pointer;decoration:none;" required="" name="imagen" id="Div2" type="file" accept="image/*">
      <center> <asp:FileUpload style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer;decoration:none;"  runat="server" id="btnSubirImg3"  onchange="readURL3(this);" runat="server"></asp:FileUpload></center></div>

    
                                        <img src="" id="Imagen3" runat="server"  style=" width:250px;  height:250px;border: 8px solid #fff;
    box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.2); object-fit:cover; margin-top:15px;" />
      <br />  
                                    ...
                                    <div alt="Cargando Imagen..." style="background-image:url('Imagenes/subir.png');background-size: cover;height:50px;width:50px;cursor:pointer;decoration:none;" required="" name="imagen" id="Div3" type="file" accept="image/*">
      <center> <asp:FileUpload style="background-image:url('Imagenes/ErrorTickets.png');background-size: cover; opacity: 0; height:80px;width:80px;cursor:pointer; decoration:none;"  runat="server" id="btnSubirImg4"  onchange="readURL4(this);" runat="server"></asp:FileUpload></center></div>

                                        <img src="" id="Imagen4" runat="server"  style=" width:250px;  height:250px;border: 8px solid #fff;
    box-shadow: 0px 0px 30px rgba(0, 0, 0, 0.2); object-fit:cover; margin-top:15px;" />
                                        <br />  
                    ...
                    ACEPTAR</button>
                        ...
                        <asp:HiddenField ID="HfID_Item" runat="server" />
