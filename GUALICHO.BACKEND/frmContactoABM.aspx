<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmContactoABM.aspx.vb" Inherits="GUALICHO.BACKEND.frmContactoABM_aspx" %>
                                   ...
                                   <%--EMPIEZO BACKEND--%>
                                    ...
                                    <center>
                                       ...
                                       <div class="col col-md-4">
                                         <span style="color:#ef7f2d; font-size:18px; "> Dirección</span>
                                             <asp:TextBox ID="txtDireccion" required runat="server"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                       </div>
                                            <div class="col col-md-4">
                                         <span style="color:#ef7f2d; font-size:18px; "> Email</span>
                                             <asp:TextBox ID="txtEmail" required runat="server"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                       </div>
                                            <div class="col col-md-4">
                                         <span style="color:#ef7f2d; font-size:18px; "> Teléfono</span>
                                             <asp:TextBox ID="txtTelefono" required runat="server"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
                                       </div>
                                            ...
                                            <br />
                                             ...
                                             <div class="row">
                                                 ...
                                                 <div class="col col-md-6">
                                                      <span style="color:#ef7f2d; font-size:18px; "> Instagram</span>
                                             <asp:TextBox ID="TxtInstagram" required runat="server"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>

                                                 </div>

                                                 <div class="col col-md-6">
                                                         <span style="color:#ef7f2d; font-size:18px; "> Facebook</span>
                                             <asp:TextBox ID="TxtFacebook" required runat="server"  ForeColor="Black"
                                                    class="form-control"  Height="50px" Width="100%"></asp:TextBox>
