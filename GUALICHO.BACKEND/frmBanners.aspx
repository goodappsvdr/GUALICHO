<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmBanners.aspx.vb" Inherits="GUALICHO.BACKEND.frmBanners" %>
...
<div class="se-pre-con"></div>
          ...
          <div id="sidebar-menu">
                    <ul>
                        ...
                        <li id="Men_ItemImagen" visible="false" runat="server" class="has_sub"><a href="javascript:void(0);"
                            class="waves-effect" style="background:#000;"><i class="zmdi zmdi-view-list"></i><span>Imagenes de Productos</span><span
                                class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
 ...
 <center>
                                <a href="./frmBannersABM.aspx" style=" background:#000 !important; border: 1px solid #000 !important;" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5"> NUEVA PORTADA</a>
