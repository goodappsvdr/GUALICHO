<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmItems.aspx.vb" Inherits="GUALICHO.BACKEND.FrmItems" %>
...
<div class="se-pre-con"></div>
                                ...
                                <table id="datatable" class="table table-striped table-bordered" style="cursor:pointer;">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="RepeaterItems" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <th  onClick="window.open( '<%# Eval("urlweb")%>','_top' ); return false;">
                                                        <a href="<%# Eval("urlweb")%>" style="text-decoration: none;">
                                                            <%# Eval("Descripcion")%></a>
                                                    </th>
                                                      <th  onClick="window.open( '<%# Eval("urlweb")%>','_top' ); return false;">
                                                    ...
                                                    <th onclick="ValidarEliminar(<%# Eval("ID_Item")%>,'<%# Eval("Descripcion")%>')">
                                                        <center>
                                                        <img src="Imagenes/cruz.png"/>
                                                        <span style=" background:#FF0A0A; padding:8px; color:white; border-radius:20px; font-size:11px;">ELIMINAR ITEM</span>
                                                        </center>
                                                    </th>
 ...
 <center>
                                <a href="./frmItemsABM.aspx" style=" background:#ef7f2d !important; border: 1px solid #ef7f2d !important;" class="btn btn-success btn-rounded w-md waves-effect waves-light m-b-5"> NUEVO ITEM</a>
    ...
    <script type="text/javascript">
        ...
        function ValidarEliminar(id,descripcion) {

            swal({
                title: "¿Estás seguro/a de Eliminar el item: " + descripcion + "?",
                type: "question",
                ...
                success: function (data) {
                    ...
                    if (status == 200) {
                        ...
                        swal({
                            backdrop: true,
                            allowOutsideClick: false,
                            title: 'Items Eliminado Éxito!!',
                            text: '',
                            type: 'success',
                            confirmButtonText: 'CONTINUAR',
                        }).then(function () {
                            window.location = "frmItems.aspx";
                        })
